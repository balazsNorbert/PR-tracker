...
function Home() {
  return (
    <div className="flex flex-col gap-8 items-center h-screen justify-center text-white mx-10">
      ...
      <button className="bg-gray-700 hover:bg-teal-600 font-semibold text-xl xl:text-2xl py-3 px-6 rounded-lg transition duration-300"><Link to="/logbook">Go To LogBook</Link></button>
    </div>
  );
}
