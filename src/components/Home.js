...
function Home() {
  return (
    <div className="flex flex-col gap-8 items-center h-full justify-center mx-5 md:mx-10">
      <h1 className="text-3xl md:text-4xl xl:text-5xl font-bold text-center mt-10">Welcome to your Training Logbook!</h1>
      ...
      <button className="bg-gray-700 dark:bg-teal-600 hover:bg-teal-600 dark:hover:bg-teal-500 font-semibold text-xl xl:text-2xl
