...
function Home() {
  ...
  return (
    <>
      <section className="flex flex-col gap-8 items-center mint-h-screen justify-center px-5 py-20">
      ...
      <section className="flex flex-col gap-8 items-center mint-h-screen justify-center bg-gradient-to-tr from-gray-700 to-gray-900 py-20">
